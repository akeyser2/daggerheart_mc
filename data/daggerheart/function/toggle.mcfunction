...
summon text_display ~ ~0.7 ~ {Tags:["dh_text","dh_melee","dh_new"],text:{text:"Melee",color:"red",bold:true},billboard:"center",teleport_duration:2,background:0,shadow_radius:0f,transformation:{scale:[0.5f,0.5f,0.5f], translation:[0f,0f,0f], left_rotation:[0f,0f,0f,0f],right_rotation:[0f,0f,0f,0f]}}
summon text_display ~ ~0.7 ~ {Tags:["dh_text","dh_vclose","dh_new"],text:{text:"Very Close",color:"gold",bold:true},billboard:"center",teleport_duration:2,background:0,shadow_radius:0f,transformation:{scale:[0.5f,0.5f,0.5f], translation:[0f,0f,0f], left_rotation:[0f,0f,0f,0f],right_rotation:[0f,0f,0f,0f]}}
summon text_display ~ ~0.7 ~ {Tags:["dh_text","dh_close","dh_new"],text:{text:"Close",color:"yellow",bold:true},billboard:"center",teleport_duration:2,background:0,shadow_radius:0f,transformation:{scale:[0.5f,0.5f,0.5f], translation:[0f,0f,0f], left_rotation:[0f,0f,0f,0f],right_rotation:[0f,0f,0f,0f]}}
summon text_display ~ ~0.7 ~ {Tags:["dh_text","dh_far","dh_new"],text:{text:"Far",color:"green",bold:true},billboard:"center",teleport_duration:2,background:0,shadow_radius:0f,transformation:{scale:[0.5f,0.5f,0.5f], translation:[0f,0f,0f], left_rotation:[0f,0f,0f,0f],right_rotation:[0f,0f,0f,0f]}}
summon text_display ~ ~0.7 ~ {Tags:["dh_text","dh_vfar","dh_new"],text:{text:"Very Far",color:"blue",bold:true},billboard:"center",teleport_duration:2,background:0,shadow_radius:0f,transformation:{scale:[0.5f,0.5f,0.5f], translation:[0f,0f,0f], left_rotation:[0f,0f,0f,0f],right_rotation:[0f,0f,0f,0f]}}
